...
public interface QuestionnaireEntityMapper {
     ...
     * @return
     */
    int modifyHistoryQuestionnaireStatus(Map<String, Object> map);
     ...
     * @return
     */
    Map<String,String> queryQuestionnaireById(Map<String, Object> map);
     ...
     * @return
     */
    int addSendQuestionnaire(Map<String, Object> map);
     ...
     * @return
     */
    int modifyQuestionnaireInfo( Map<String,Object> map);
     ...
     * @return
     */
    List<Map<String,Object>> queryHistoryQuestionnaire(Map<String, Object> map);
     ...
     * @return
     */
    int modifyQuestionnaire(Map<String, Object> map);
     ...
     * @return
     */
    int modifyQuestionnaireStatus(Map<String, Object> map);
    ...
    int deleteTableByTableName(@Param("tableNameAnswer") String tableNameAnswer,
                               @Param("tableNameSchool") String tableNameSchool,@Param("questionId") String questionId);
    ...
    List<Map<String, Object>> selectByPrimaryKey1(String id);

    void modifyQuestionnaire1(Map<String, Object> map);

    void modifyQuestionnaireInfo1(Map<String, Object> map);
