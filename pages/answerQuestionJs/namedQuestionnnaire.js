...
function quickCreate() {
    ...
    if (urlObj.i == "") {
        ...
        da1 = {
            ...
            'projectName':getCookie('projectName'),
            'answerTotal':"0",
            'questionTitle':getCookie("questionTitle"),
            "lastUpdatedBy":getCookie("userName"),
            'questionList':getCookie("questionList")
        };
...
function queryQuestionnaireAllSuccess(res) {
    ...
    if (res.code == '666') {
        //console.log(da1);
        var url = '/addQuestionnaire';
        commonAjaxPost(false, url, da1, addQuestionnaireSuccess);
    } else {
        layer.msg(res.message, {icon: 2});
    }
}